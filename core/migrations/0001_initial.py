# Generated by Django 2.2.3 on 2022-09-03 21:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('N', 'NVIDIA'), ('A', 'AMD'), ('I', 'Intel')], max_length=2)),
                ('label', models.CharField(choices=[('L', 'Последняя цена'), ('S', 'Скидка'), ('A', 'Акция')], max_length=1)),
